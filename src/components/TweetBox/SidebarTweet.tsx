  ...
  return (
    <>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="max-w-xl w-full p-0 rounded-2xl overflow-hidden shadow-2xl">
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center px-4 py-3 border-b">
                        ...
                        >
                            <svg viewBox="0 0 24 24" width={24} height={24} fill="none">
                                <path d="M18 6L6 18" stroke="#0f1419" strokeWidth="2" strokeLinecap="round"/>
                                <path d="M6 6L18 18" stroke="#0f1419" strokeWidth="2" strokeLinecap="round"/>
                            </svg>
                        </button>
                                ...
                                <div className="relative mt-2">
                                    ...
                                    >
                                        <svg viewBox="0 0 24 24" width={20} height={20} fill="none">
                                            ...
                                            <path d="M15 9L9 15" stroke="#0f1419" strokeWidth="2" strokeLinecap="round"/>
                                            <path d="M9 9L15 15" stroke="#0f1419" strokeWidth="2" strokeLinecap="round"/>
                                        </svg>
                                    </button>
                                </div>
                            )}
                    ...
                    <div className="flex items-center px-4 pb-3 pt-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <span className={`text-xs ${tweetContent.length === 250 ? "text-red-500" : "text-gray-400"}`}>
